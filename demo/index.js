...
function __variableDynamicURLRuntime1__(path) {
  switch (path) {
...
const { getLocale, setLocale } = window.localization ??
    configureLocalization({
        ...
        targetLocales,
        loadLocale: _locale => {
            console.log(`Loading local from: ${__variableDynamicURLRuntime0__(`./locales/${_locale}.js`).href}`);
            return import(
            /* @vite-ignore */ __variableDynamicURLRuntime1__(`./locales/${_locale}.js`)
                .href);
        },
    });
/*
