...
## [0.0.17](https://github.com/stee-re/oscd-shell/compare/oscd-shell-v0.0.16...oscd-shell-v0.0.17) (2026-09-18)


### Features

* add keyboard navigation to search functionality (ctrl+shift+f) ([30a4949](https://github.com/stee-re/oscd-shell/commit/30a4949782ec3de815e9e927249445a4b1a48283))
* add placeholder item for empty pinned editors group ([3f085e5](https://github.com/stee-re/oscd-shell/commit/3f085e5b41309d849265ed1e909be5c4f41bbf41))
* add plugin grouping support ([64d3b34](https://github.com/stee-re/oscd-shell/commit/64d3b34b32e98b43c8517f74be2ba8aceed50afd))
...
* add support for collapsible editors panel with flyout group menus ([df4adfd](https://github.com/stee-re/oscd-shell/commit/df4adfd02511b7b3761230a11e36a162766fb5ee))
* add support for grouping plugins ([0089a09](https://github.com/stee-re/oscd-shell/commit/0089a09e317424f9e9122a9d80d9fa10612fbe3f))
* add support for new --oscd-shape design token ([013a47d](https://github.com/stee-re/oscd-shell/commit/013a47de549303625a4684637ab43c7de2d50789))
* add support for tagName to plugins ([3b06907](https://github.com/stee-re/oscd-shell/commit/3b069078d48951d3ac09159435baab103837d97d)), closes [#40](https://github.com/stee-re/oscd-shell/issues/40)
...
* app-bar updated design ([3946d32](https://github.com/stee-re/oscd-shell/commit/3946d320ac58d33b1c7aa21ebf847c74147c10c1))
* cleanup Plugin interface namings & prevent plugins property mutation ([4d77761](https://github.com/stee-re/oscd-shell/commit/4d77761c9dff54f70960d1a5e7e8a7fee99510ee))
...
* expose css design tokens so shell can be correctly customized ([657b996](https://github.com/stee-re/oscd-shell/commit/657b996d4ca7bb5d7dc4adae1f2281d6b14cf976))
* fix npm publishing ([432f359](https://github.com/stee-re/oscd-shell/commit/432f359734e0def5913c3dde548427572267b40f))
* fix npm publishing ([15f10d1](https://github.com/stee-re/oscd-shell/commit/15f10d1f4284fea1fa625505e8305e1f3a09bdbd))
...
* realign branding defaults to vanilla solarized ([b5ccdf7](https://github.com/stee-re/oscd-shell/commit/b5ccdf727e6b0a17f7fbc114f9b340419b213fe6))
* realign branding defaults to vanilla solarized ([e13a9c4](https://github.com/stee-re/oscd-shell/commit/e13a9c40087d71c6aadbc9fa45d7eaabd177643f))
* refactor oscd-shell to fully support scoped custom elements ([77a5bea](https://github.com/stee-re/oscd-shell/commit/77a5beac60e401f85e15d01ac3d8b6457ddb6c4a))
...
* stateVersion should be docVersion ([a40c701](https://github.com/stee-re/oscd-shell/commit/a40c70112a0396442b3b94a22c01b896c30b7b92)), closes [#71](https://github.com/stee-re/oscd-shell/issues/71)
* support rendering without appIcon ([903b690](https://github.com/stee-re/oscd-shell/commit/903b690e0d91ca6a6c352d1a0104d3096ce693a9))
...
* switch side-panel to use oscd-ui oscd-outlined-search-field ([134f6ce](https://github.com/stee-re/oscd-shell/commit/134f6ce865cc42a952956ff856a4f39e6e497709))
* update tooling and all module deps ([d6b6bf8](https://github.com/stee-re/oscd-shell/commit/d6b6bf868afa2f950cc2be8025c5cd2d806621dd))
* update UI to new design ([edb8b29](https://github.com/stee-re/oscd-shell/commit/edb8b296aed487c04dafe85e0578194f56ce7ce6))


### Bug Fixes

* add accessory icon to pinned tree too ([f7de87e](https://github.com/stee-re/oscd-shell/commit/f7de87e853e09706581f6084dea69279e8cdf136))
* adjust tests after updating modules ([7cf82cb](https://github.com/stee-re/oscd-shell/commit/7cf82cb61720900bcb8814e60faf2f1c0fd9865f))
* align mdc colors with open-scd defaults ([8112719](https://github.com/stee-re/oscd-shell/commit/811271930b3d90cc26d850ec44d97540bee940ef))
* broken demo on bundle ([1d6a72d](https://github.com/stee-re/oscd-shell/commit/1d6a72d288da4eb8dff6a619e2d219f9c1a2d151))
* broken npm build ([8bbc236](https://github.com/stee-re/oscd-shell/commit/8bbc236e7fdd61121de0c469bc17a99535a94f59))
* change all theme references to use --oscd-theme-* ([e169ade](https://github.com/stee-re/oscd-shell/commit/e169ade3b3244c63cfbc6ceb768ec17b7767a054))
* change locale and docName from plugin attrs to props ([ed4f4cb](https://github.com/stee-re/oscd-shell/commit/ed4f4cb100e547492cdef121a7e175113550b3e6))
* correct issues with bundling, so shell can be used from a uri pointing to a bundle ([2d728ae](https://github.com/stee-re/oscd-shell/commit/2d728ae8e19f02bb58364854e21c3e40ca4b4e6a))
* correct path issues with dyn loaded locales ([6efd5ae](https://github.com/stee-re/oscd-shell/commit/6efd5ae0596abedecd98d1bedb30e17efda63a12))
* correct search box alignment issues ([cc5b330](https://github.com/stee-re/oscd-shell/commit/cc5b330b7fa1d1c2980836c2af20b248e0b26319))
* handleEditEventV2 should respect squash and title ([62e21d3](https://github.com/stee-re/oscd-shell/commit/62e21d3d1d342c60206bdcc5981905b21b05eb70))
* include styling overrides for plugins-menu button ([98ac0ab](https://github.com/stee-re/oscd-shell/commit/98ac0aba8a3fd56f60d048e1fa5de7ff3e95ca70))
...
* pin footer (and footer-divider) to bottom of the side panel so scrolling is within ([6c2dafa](https://github.com/stee-re/oscd-shell/commit/6c2dafaed3463fd175e7dac898b15bb107edb7ce))
* pinned tree bleeds into main tree in editors sidepanel ([983cf75](https://github.com/stee-re/oscd-shell/commit/983cf75f6080b755b922771687de0c5790553689))
...
* removing cyclical css design toeken refs - general cleanup of token use ([5064208](https://github.com/stee-re/oscd-shell/commit/5064208f5eb3cefa9c5031a16c9e9be1ac60a147))
* set default them colors using omicron color palette ([1cbba92](https://github.com/stee-re/oscd-shell/commit/1cbba926b4f0554de4c0489693d5b9f1116ab6a5))
* update to the latest oscd-editor to fix undo/redo issues ([16cf2ed](https://github.com/stee-re/oscd-shell/commit/16cf2edf799c37f3141f83ccc4795eb5e3a513c9))
...
* improve default theme contrast ([277840b](https://github.com/stee-re/oscd-shell/commit/277840bc623ffd5adaa76215ff6ab094fa25fe29))
